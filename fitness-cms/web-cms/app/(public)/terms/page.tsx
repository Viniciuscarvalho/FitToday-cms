    ...
    <div className="min-h-screen bg-brand-background text-brand-textSecondary">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="space-y-8 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc list-inside mt-3 space-y-1">
              ...
              <li>
                ...
                programas adquiridos. A plataforma retém uma comissão conforme o plano escolhido.
              </li>
            </ul>
          </section>
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mb-3">4. Pagamentos e Comissões</h2>
            <p>
              Os pagamentos realizados por alunos são processados pela Stripe, nosso parceiro de
              pagamentos. A FitToday retém uma comissão variável dependendo do plano do trainer.
              O valor restante é repassado ao personal trainer conforme o cronograma de pagamentos
              da Stripe.
            </p>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mb-3">5. Conteúdo do Usuário</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mb-3">8. Rescisão</h2>
            <p>
          ...
          <section>
            ...
            <p>
              ...
              <a
                href="mailto:suporte@fittoday.me"
